...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        demopoints.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AdsManager.ShowInterstitialAd(MainActivity.this, brief.class);
                finish();
            }
        });
        bonus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AdsManager.ShowInterstitialAd(MainActivity.this, bonus_ads.class);
            }
        });
        deposit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AdsManager.ShowInterstitialAd(MainActivity.this, deposit.class);
            }
        });
        withdraw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AdsManager.ShowInterstitialAd(MainActivity.this, withdraw.class);
            }
        });
    }
    ...
    private void saveEarnings(int earnedcoins) {
        ...
        Toast.makeText(this, "You have got " + earnedcoins, Toast.LENGTH_SHORT).show();
    }
}